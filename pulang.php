				...
				<div class="content-top-grids">
					...
					<div class="col-md-4 contact-right">
						...
						<div class="contact-right-middle">
							...
							<div class="login-info">
								...
								<a href="login"><input class="wow fadeInRight animated" data-wow-delay=".5s" type="submit" name="Sign In" value="Masuk Sebagai Admin">
					...
					<div class="col-md-4 content-right">
						<div class="clock-grids wow fadeInRight animated" data-wow-delay=".5s">
								...
								<div class="resp-tabs-container">
									...
									<div class="new_posts resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-0" style="display:block">
										<div class="posts-grids">
											<h3>5 Karyawan Pulang Terakhir</h3>
											<?php 
											$s_absen1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi where tanggal='$skr' AND pulang !='0' order by pulang DESC limit 5");
							...
							<div class="clock-bottom">
								<div class="clock">
									<marquee scrollamount="3"><b style="color:white" >Terimakasih Atas Kehadirannya </b></marquee>
