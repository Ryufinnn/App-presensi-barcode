...
<html lang="en-US">
	<head>
		...
		<meta name="description" content="<?= $app['nama_perusahaan'];?>">
		...
		Fonts and CSS
		=============================================== -->
		<link href="httpss://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet" type="text/css">
		...
		<div id="ascensor">
			<section class="section home">
				<div class="center-box">
					...
					<div class="row">
							<div class="socialize">
								<h2 class="h2"><img src="app/images/<?= $app['logo'] ?>" width="10%" alt="Image"> <?= $app['nama_aplikasi'];?></h2>
							</div>
						</div>
						<div class="tile">
						</div>
