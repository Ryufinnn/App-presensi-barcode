...
<head>
    ...
    <link rel="shortcut icon" href="images/icon/setjek-logo.png">
	...
	<div >
		...
		<div class="container">
			...
			<div class="content-grids">
				...
				<div class="content-top-grids">
					...
					<div class="col-md-4 contact-right">
						...
						<div class="contact-right-middle">
							<div class="contact-right-middle-heading">
								<h3><img src="images/barcode.png" width="20%" alt="Image">
									PRESENSI MASUK </h3>
								<?php 
									if(isset($pesan)) {
										?>
							...
							<div class="login-info">
								<form action="controllers/masuk" name="testForm"  method="POST">
									<input type="text" id="barcode" class="user" onLoad="this.focus();" onChange="document.testForm.submit()" name="nik" placeholder="Scan Barcode"  />
								</form>
								<a href="login"><input type="submit" name="Sign In" value="Masuk Sebagai Admin">
								</a><a href="index" style="font-size: 14px; font-weight: 600;"> Kembali ke Halaman Awal</a>
					...
					<div class="col-md-4 content-right">
						<div class="clock-grids">
								...
								<div class="resp-tabs-container">
									...
									<div class="new_posts resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-0" style="display:block">
										<div class="posts-grids">
											<h3>5 Presensi Terakhir</h3>
											<?php 
											$s_absen1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi where tanggal='$skr' AND masuk!='NULL' order by masuk DESC limit 5");
							...
							<div class="clock-bottom">
								<div class="clock">
									<marquee scrollamount="3"><b style="color:white" >Selamat Datang </b></marquee>
				...
				<div class="clearfix"> </div>
				<div class="copyright" >
					<p>© <?= date('Y') ?> <?= $app['nama_perusahaan'];?> . Kerja Praktik</p>
				</div>
			</div>
		</div>
	</div>
