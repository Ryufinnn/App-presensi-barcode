                        ...
                        <div class="body">
                                        ...
                                        <tr>
											<td><?php if($_SESSION['area']=='all') { ?><div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="controller/lokasi_hapus?id=<?= $d_karyawan['id'];?>" onclick="return confirm('Apakah Lokasi Kota <?= $d_karyawan['kode'];?> <?= $d_karyawan['lokasi'];?> akan dihapus ?')">Hapus</a></li>
												</ul>
								...
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Tambah Lokasi Kota</h4>
										</div>
											...
											<form action="controller/lokasi_simpan" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="row clearfix">
													<div class="col-sm-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text" name="kode" class="form-control" placeholder="Masukkan Kode Kota" required>
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													...
													<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text"  name="lokasi" class="form-control" placeholder="Masukan Nama Kota" required>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="modal fade" id="edit" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Edit Lokasi Kota</h4>
										</div>
										<div class="modal-body">
											...
											<form action="controller/lokasi_edit" class="form-horizontal" method="POST" enctype="multipart/form-data">
													...
													<div class="col-sm-7">
														<div class="form-group">
															<div class="form-line">
																...
																<input type="text" id="kode" name="kode" class="form-control" placeholder="Edit Kode Kota" required>
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													...
													<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text" id="lokasi" name="lokasi" class="form-control" placeholder="Edit Nama Kota" required>
															</div>
														</div>
													</div>
												</div>
