                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
								<li role="presentation" class="active">
                                    <a href="#profile_only_icon_title" data-toggle="tab">
                                        <i class="material-icons">face</i> ADMIN PENGGUNA
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                        ...
                                        <tr>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a class="pilih_user" href="" data-toggle="modal" data-target="#edituser" u1="<?= $d_user['id'];?>" u2="<?= $d_user['username'];?>" u3="<?= $d_user['password'];?>" u4="<?= $d_user['nama'];?>" >Edit</a></li>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="settings_only_icon_title">
									...
									<div align="center">
									  <p><em>Fitur Aplikasi ini digunakan untuk backup atau mencadangkan semua data yang ada didalam database &quot;<strong><?= $db ?></strong>&quot;.</em></p>
									  </br></br>
									  <p>
										<button class="btn btn-primary" type="submit" name="backup"  onClick="return confirm('Apakah Anda yakin?')" ><i class="fa fa-download"></i> Mulai Backup Database</button>
									  </p>
								  </div>
								</form>
								</p>
								...
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Tambah Admin Pengguna</h4>
										</div>
										<div class="modal-body">
											<form action="controller/user_simpan" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="row clearfix">
													<div class="col-sm-10">
														<div class="form-group">
															<div class="form-line">
																<input type="text" name="username" class="form-control" placeholder="Nama Admin Pengguna" required>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="modal fade" id="edituser" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Edit Admin Pengguna</h4>
										</div>
										<div class="modal-body">
											...
											<form action="controller/user_edit" class="form-horizontal" method="POST" enctype="multipart/form-data">
													...
													<div class="col-sm-7">
														<div class="form-group">
															<div class="form-line">
																...
																<input type="text" id="username" name="username" readonly="readonly" class="form-control" placeholder="Nama Admin Pengguna" required>
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													...
													<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text" id="nama_user" name="nama" readonly="readonly" class="form-control" placeholder="Nama Lengkap" required>
															</div>
														</div>
													</div>
												</div>
