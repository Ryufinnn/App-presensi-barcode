                        ...
                        <div class="body">
                                        ...
                                        <tr>
											<td><?php if($_SESSION['area']=='all') { ?><div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="controller/subarea_hapus?id=<?= $d_karyawan['id'];?>" onclick="return confirm('Apakah Lokasi Wilayah <?= $d_karyawan['kode_subarea'];?> <?= $d_karyawan['subarea'];?> akan dihapus ?')">Hapus</a></li>
												</ul>
								...
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Tambah Lokasi Wilayah</h4>
										</div>
											...
											<form action="controller/subarea_simpan" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="row clearfix">
													<div class="col-sm-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text" name="kode_subarea" class="form-control" placeholder="Masukkan Kode Wilayah" required>
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													...
													<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text"  name="subarea" class="form-control" placeholder="Masukan Nama Wilayah" required>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="modal fade" id="edit" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="largeModalLabel">Edit Lokasi Wilayah</h4>
										</div>
										<div class="modal-body">
											...
											<form action="controller/subarea_edit" class="form-horizontal" method="POST" enctype="multipart/form-data">
													...
													<div class="col-sm-7">
														<div class="form-group">
															<div class="form-line">
																...
																<input type="text" id="kode_subarea" name="kode_subarea" class="form-control" placeholder="Edit Kode Wilayah" required>
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													...
													<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
														<div class="form-group">
															<div class="form-line">
																<input type="text" id="subarea" name="subarea" class="form-control" placeholder="Edit Nama Wilayah" required>
															</div>
														</div>
													</div>
												</div>
