                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
									...
									<?php
										...
										$s_karyawan = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi,karyawan  where presensi.nik=karyawan.nik AND presensi.ijin is not NULL  AND presensi.tanggal='$_GET[date]' AND karyawan.area LIKE '%$_GET[area]'");
