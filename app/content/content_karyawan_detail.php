		...
		<div id="detail">
			<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div  class="card">
                    <div class="header">
                        <h2>
                            <p align="center"> <img src="./images/<?= $app['logo'] ?>" width="40%"></img> <small></small>
                        </h2>
                    </div>
                    <div class="body"><br/>
						<p align="center"><img align="center" src="../app/images/<?= $detail['foto'];?>" width="30%"></img></p><br/>
                    </div>
					<div class="footer">
		...
		<div >
			<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <ul align="left">
                            <li>NIK Karyawan:  <?= $detail['nik'];?></li>
                            <li>Nama Karyawan :  <?= $detail['nama'];?></li>
                            <li>Kode Jabatan :  <?= $detail['job_title'];?></li>
                            <li>Nomor Telp. :  <?= $detail['no_telp'];?></li>
                            <li>Agama :  <?= $detail['agama'];?></li>
                            <li>Jenis Kelamin :  <?= $detail['jenis_kelamin'];?></li>
                            <li>Kota :  <?= $detail['lokasi'];?></li>
                            <li>Kode Daerah :  <?= $detail['area'];?></li>
                            <li>Wilayah :  <?= $detail['sub_area'];?></li>
                            <li>Mulai Tanggal :  <?= $detail['start_date'];?></li>
                            <li>Berakhir Tanggal :  <?= $detail['end_date'];?></li>
                        </ul>
					</div>
                </div>
            </div>
