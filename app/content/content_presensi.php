			...
			<form method="get">				
				<div class="col-sm-3 ">
					<div class="form-group">
						<div class="form-line">
							<input type="text" id="date" name="start_date" value="<?= $_GET['start_date']?>" class="datepicker form-control" data-date-format="yyyy/mm/dd" placeholder="Mulai Tanggal" required>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						<div class="form-line">
							<input type="text" id="date2" name="end_date" value="<?= $_GET['end_date']?>" class="datepicker form-control" data-date-format="yyyy/mm/dd" placeholder="Berakhir Tanggal" required>
						</div>
					</div>
				</div>
				<div class="col-sm-4 ">
		...
		<a href="ijin"> <div class="col-md-3">
					<div class="info-box-3 bg-red hover-zoom-effect">
                        ...
                        <div class="content">
							...
							$skr = date('Y-m-d');
							$s_absen = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi where tanggal='$skr' and ijin is NULL order by masuk DESC");
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
									<?php
										$s_absen = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM presensi,karyawan where presensi.nik=karyawan.nik AND tanggal between '$_GET[start_date]' AND '$_GET[end_date]' AND karyawan.area LIKE '%$_GET[area]'");
									...
									?>
                                        <tr>
											...
											<!--?
                                            <td>
												<?php $hourdiff  = round((strtotime($d_absen['pulang']) - strtotime($d_absen['masuk']))/3600, 1);
								...
								<div class="modal-dialog modal-sm" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="smallModalLabel">Edit Presensi<h4>
										</div>
										<div class="modal-body">
										<form name="myForm" id="myForm" action="controller/presensi_edit.php?start_date=<?= $_GET['start_date'];?>&end_date=<?= $_GET['end_date'];?>&area=<?= $_GET['area'];?>" method="post" enctype="multipart/form-data">
											<div class="row clearfix">
													<div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
														<label for="email_address_2">NIK Karyawan</label>
													</div>
													<div class="col-sm-8">
														<div class="form-group">
															<div class="form-line">
