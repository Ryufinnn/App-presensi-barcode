			...
			<div class="block-header">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-blue hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">KARYAWAN AKTIF</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-green hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">KARYAWAN MASUK</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-cyan hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">KARYAWAN PULANG</div>
                            <div class="number"><?php 
						$s_pulang = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi where tanggal='$skr' AND pulang !='0' order by pulang DESC");
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-group">
								...
								<?php
								$d_masuk = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi,karyawan where presensi.nik= karyawan.nik AND karyawan.area='$d_area[kode_area]' AND presensi.tanggal='$skr' AND presensi.ijin is NULL"));
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-group">
								...
								<?php
								$d_masuk1 = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from presensi,karyawan where presensi.nik= karyawan.nik AND karyawan.area='$d_area1[kode_area]' AND presensi.tanggal='$skr' AND presensi.ijin is NULL"));
